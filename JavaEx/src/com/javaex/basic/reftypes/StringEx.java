...
public class StringEx {
	...
	private static void stringFormatEx() {	//	format문자열로 행하나를 좀더 깔끔하고 명확하게 작성할 수 있다.
		...
		String fmt = "%d개의 %s중에서 %d개를 먹었다";	//	탬플릿을 미리 만들어두고
		...
		fmt = "현재 이자율은 %.2f%%입니다. %n";	//	%.2f의 의미는 소숫점 2째 자리까지 표기(부가정보)
	...
	private static void stringTest() {
		...
		System.out.println("str과 str3 내용이 같은가? " + str.equals(str3));	//	같은 객체이지만 결과는 다르다.
	}
