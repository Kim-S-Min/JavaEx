...
//		파일 내용을 기록하는 것은 Stream을 생성
public class FileClassEx {
	// 현재 프로젝트 내의 루트 디렉터리 위치
	private static String rootPath = System.out.getproperty("user.dir" + "\\files\\")
	public static void main(String[] args) {
		...
		//	새로운 파일 생성하고자 할 경우
		File file = new File(rootPath + "\\myFile.txt");	//	새 파일이 생성되는 것은 아니다
		...
		//	파일 삭제
		System.out.println("=> mtFile.txt 삭제");
		file.delete();
